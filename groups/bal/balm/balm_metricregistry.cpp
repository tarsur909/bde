...
(__out == true ==> SFORALL(0, strlen(candidatePrefix), i, (candidatePrefix + i ↦ candidatePrefix[i]) && (string + i ↦ candidatePrefix[i]))) && (__out == false ==> SEXISTS(0, strlen(candidatePrefix), i, (candidatePrefix + i ↦ candidatePrefix[i]) && (string + i ↦ string[i]) && (candidatePrefix[i] != string[i])))
...
// MANIPULATORS
(__out != MetricId() ==> ret.second == true) && (__out == MetricId() ==> ret.second == false)
