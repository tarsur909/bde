...
(__out == true ==> SFORALL(0, strlen(candidatePrefix), i, (candidatePrefix + i ↦ string[i]))) && (__out == false ==> EXISTS(0, strlen(candidatePrefix), i, (candidatePrefix[i] != string[i] || string[i] == 0)))
