...
(__out.second == false ==> d_metrics.find(__out.first) != d_metrics.end()) && (__out.second == true ==> d_metrics.find(__out.first) == d_metrics.end())
...
// MANIPULATORS
(ret.second ==> __out == ret.first) && (!ret.second ==> __out == MetricId())
