...
// requires: FORALL(0, strlen(candidatePrefix), i, candidatePrefix[i] == string[i]) ==> (strlen(candidatePrefix) <= strlen(string))
// ensures: __out == true ==> FORALL(0, strlen(candidatePrefix), i, candidatePrefix[i] == string[i])
...
// requires: true
// ensures: __out.second == true || __out.second == false
