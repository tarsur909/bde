...
// MANIPULATORS
(__out == -1 ==> (d_generalPublishers.end() != d_generalPublishers.find(publisher) || (d_registry.find(publisher) != d_registry.end() && !d_registry.find(publisher)->second.empty()))) && (__out == 0 ==> d_generalPublishers.end() != d_generalPublishers.find(publisher))
