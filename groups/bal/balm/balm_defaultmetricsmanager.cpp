...
namespace balm {
// CLASS METHODS
// requires: bslma::Default::globalAllocator(basicAllocator) != 0 && s_allocator_p == 0 && s_singleton_p == 0
// ensures: (__out != 0) && (s_singleton_p ↦ __out) && (s_allocator_p ↦ bslma::Default::globalAllocator(basicAllocator))
