...
// MANIPULATORS
(__out.d_state == e_NOT_PARSED && rhs.d_state == e_NOT_PARSED) || (__out.d_state == e_PARSED && rhs.d_state == e_PARSED && __out.d_arguments == rhs.d_arguments) && __out.d_options == rhs.d_options && __out != rhs
...
// ACCESSORS
(__out >= 0 ==> EXISTS(d_schema_p->cbegin(), d_schema_p->cend(), itr, (itr->d_name_p == name))) && (__out == -1 ==> FORALL(d_schema_p->cbegin(), d_schema_p->cend(), itr, (itr->d_name_p != name)))
