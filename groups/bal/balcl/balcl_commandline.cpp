...
// ACCESSORS
// requires: true
// ensures: __out == d_returnValue && d_returnValue ↦ _
inline
...
// requires: options.size() >= 0 && errorStream.good()
// ensures: (__out == 0) || (__out != 0 && errorStream.tellp() > 0)
...
// ACCESSORS
// requires: true
// ensures: (__out != -1 ==> EXISTS(0, d_schema_p->size(), i, (d_schema_p->begin() + i)->d_name_p == name)) && (__out == -1 ==> FORALL(0, d_schema_p->size(), i, (d_schema_p->begin() + i)->d_name_p != name))
