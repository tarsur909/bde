...
// PRIVATE ACCESSORS
(FORALL(0, d_options.size(), i, d_options[i].name() == name) ==> __out != -1) && (EXISTS(0, d_options.size(), i, d_options[i].name() == name) ==> __out != -1) && (!EXISTS(0, d_options.size(), i, d_options[i].name() == name) ==> __out == -1)
