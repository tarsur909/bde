...
// MANIPULATORS
(__out == *this) && (d_state != e_INVALID) && (d_options == rhs.d_options) && ((d_state == e_NOT_PARSED) || (d_state == e_PARSED && d_arguments == rhs.d_arguments)) && (__out == *this ==> (d_state == e_NOT_PARSED || (d_state == e_PARSED && d_arguments == rhs.d_arguments)))
