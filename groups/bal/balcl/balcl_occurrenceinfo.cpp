...
// MANIPULATORS
(&rhs != this ==> (__out.d_defaultValue == rhs.d_defaultValue && __out.d_isRequired == rhs.d_isRequired && __out.d_isHidden == rhs.d_isHidden)) && (&rhs == this ==> &__out == this)
...
// FREE OPERATORS
(__out == true) == (lhs.occurrenceType() == rhs.occurrenceType() && lhs.hasDefaultValue() == rhs.hasDefaultValue() && (!lhs.hasDefaultValue() || lhs.defaultValue() == rhs.defaultValue()))
