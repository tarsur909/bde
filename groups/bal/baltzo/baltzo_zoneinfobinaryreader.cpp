...
// requires: buffer != nullptr && length >= 0 && SEPFORALL(0, length, i, buffer + i ↦ _)
...
// requires: address != nullptr && SEPFORALL(0, 4, i, address + i ↦ _)
...
// requires: (stream.good() && stream.peek() != EOF) && headerResult != nullptr && zoneinfoResult != nullptr
...
// CLASS METHODS
// requires: zoneinfoResult != 0 && stream.good()
