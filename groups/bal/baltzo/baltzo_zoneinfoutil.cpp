...
// CLASS METHODS
// requires: resultTime != nullptr && resultTransition != nullptr && isWellFormed(timeZone)
// ensures: (__out == 0 ==> *resultTime != bdlt::DatetimeTz() && *resultTransition != Zoneinfo::TransitionConstIterator()) && (__out != 0 ==> __out == ErrorCode::k_OUT_OF_RANGE)
