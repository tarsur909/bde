...
// CLASS METHODS
(!bdls::FilesystemUtil::isDirectory(path, true) ==> __out == false) && (bdls::FilesystemUtil::isDirectory(path, true) ==> __out == bdls::FilesystemUtil::isRegularFile((std::string(path) + "/GMT").c_str(), true))
