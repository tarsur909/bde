...
(__out == -1 ==> timeZoneId[0] == '/') && (__out == -2 ==> SEXISTS(0, strlen(timeZoneId), i, !(bsl::strchr("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890/_+-", timeZoneId[i])))) && (__out == 0 ==> SFORALL(0, strlen(timeZoneId), i, bsl::strchr("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890/_+-", timeZoneId[i])))
...
// ACCESSORS
(__out == 0 ==> (result != nullptr && *result ↦ _)) && (__out != 0 ==> true)
