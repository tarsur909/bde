...
(__out == true ==> SEXISTS(0, transitions.size(), i, descriptor == transitions[i].descriptor())) && (__out == false ==> SFORALL(0, transitions.size(), i, descriptor != transitions[i].descriptor()))
static
