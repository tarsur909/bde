...
(__out == true ==> EXISTS(transitions.begin(), transitions.end(), it, (*it).descriptor() == descriptor)) && (__out == false ==> FORALL(transitions.begin(), transitions.end(), it, (*it).descriptor() != descriptor))
static
