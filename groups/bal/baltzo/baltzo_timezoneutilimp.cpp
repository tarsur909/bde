...
// requires: timeZone.numTransitions() > 0 && start >= timeZone.beginTransitions() && start < timeZone.endTransitions()
// ensures: (__out->descriptor().dstInEffectFlag() == dstFlag || __out == timeZone.endTransitions())
static
