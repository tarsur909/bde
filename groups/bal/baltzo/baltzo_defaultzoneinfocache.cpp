...
// requires: (u::userSingletonCachePtr != 0 ==> u::userSingletonCachePtr != 0) && (u::userSingletonCachePtr == 0 ==> u::systemSingletonCachePtr != 0)
...
// CLASS METHODS
// requires: true
// ensures: (__out == getenv("BDE_ZONEINFO_ROOT_PATH") && (DataFileLoader::isPlausibleZoneinfoRootPath(__out) || !DataFileLoader::isPlausibleZoneinfoRootPath(__out))) || (__out == "." && getenv("BDE_ZONEINFO_ROOT_PATH") == 0) || (__out != 0 && DataFileLoader::isPlausibleZoneinfoRootPath(__out))
