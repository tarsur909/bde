...
__out != NULL && (u::userSingletonCachePtr != NULL ==> __out == u::userSingletonCachePtr) && (u::userSingletonCachePtr == NULL ==> __out == u::systemSingletonCachePtr)
...
// CLASS METHODS
__out != NULL && (__out == getenv("BDE_ZONEINFO_ROOT_PATH") || EXISTS(0, u::k_NUM_BALTZO_DATA_LOCATIONS, ii, __out == u::BALTZO_DATA_LOCATIONS[ii]) || __out == ".")
