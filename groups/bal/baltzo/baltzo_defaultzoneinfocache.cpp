...
(u::userSingletonCachePtr != 0 ==> __out == u::userSingletonCachePtr) && (u::userSingletonCachePtr == 0 ==> __out == u::systemSingletonCachePtr)
...
// CLASS METHODS
__out != 0 && (__out == getenv("BDE_ZONEINFO_ROOT_PATH") || (__out != getenv("BDE_ZONEINFO_ROOT_PATH") ==> EXISTS(0, u::k_NUM_BALTZO_DATA_LOCATIONS, ii, __out == u::BALTZO_DATA_LOCATIONS[ii] && DataFileLoader::isPlausibleZoneinfoRootPath(u::BALTZO_DATA_LOCATIONS[ii]))) || (!EXISTS(0, u::k_NUM_BALTZO_DATA_LOCATIONS, ii, DataFileLoader::isPlausibleZoneinfoRootPath(u::BALTZO_DATA_LOCATIONS[ii])) ==> __out == "."))
