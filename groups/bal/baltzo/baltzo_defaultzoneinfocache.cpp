...
(__out == u::userSingletonCachePtr) || (__out == u::systemSingletonCachePtr && (u::systemSingletonCachePtr != 0)) ==> (__out != 0)
...
// CLASS METHODS
(__out != 0) && (__out == getenv("BDE_ZONEINFO_ROOT_PATH") || (__out != getenv("BDE_ZONEINFO_ROOT_PATH") ==> (EXISTS(0, u::k_NUM_BALTZO_DATA_LOCATIONS, ii, __out == u::BALTZO_DATA_LOCATIONS[ii]) || __out == ".")))
