...
__out == (drainRate * timeInterval.seconds() + (drainRate / 1000000000) * timeInterval.nanoseconds() + (*fractionalUnitDrainedInNanoUnits + (drainRate % 1000000000) * timeInterval.nanoseconds()) / 1000000000
