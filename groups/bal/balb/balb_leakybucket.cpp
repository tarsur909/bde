...
// MANIPULATORS
// requires: true
// ensures: (__out == bsls::TimeInterval(0, 0) || __out != bsls::TimeInterval(0, 0)) && (__out == bsls::TimeInterval(0, 0) ==> (d_unitsInBucket + d_unitsReserved < d_capacity)) && (__out != bsls::TimeInterval(0, 0) ==> (d_unitsInBucket + d_unitsReserved >= d_capacity))
