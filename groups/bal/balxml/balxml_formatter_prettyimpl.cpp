...
// CLASS METHODS
// requires: state != nullptr && (state->id() == StateId::e_IN_TAG || state->id() == StateId::e_FIRST_DATA_BETWEEN_TAGS || state->id() == StateId::e_TRAILING_DATA_BETWEEN_TAGS || state->id() == StateId::e_FIRST_DATA_AT_LINE_BETWEEN_TAGS)
