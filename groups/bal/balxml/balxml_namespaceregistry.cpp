...
(__out >= balxml::NamespaceRegistry::e_PREDEF_MIN ==> EXISTS(0, ARRAY_LEN(predefinedNamespaces), i, namespaceUri == predefinedNamespaces[i])) && (__out == -1 ==> FORALL(0, ARRAY_LEN(predefinedNamespaces), i, namespaceUri != predefinedNamespaces[i]))
