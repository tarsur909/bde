...
(EXISTS(0, predefinedNamespaces.size(), i, namespaceUri == predefinedNamespaces[i] ==> __out == i + balxml::NamespaceRegistry::e_PREDEF_MIN)) && (FORALL(0, predefinedNamespaces.size(), i, namespaceUri != predefinedNamespaces[i]) ==> __out == -1)
