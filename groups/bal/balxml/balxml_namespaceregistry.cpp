...
(__out >= balxml::NamespaceRegistry::e_PREDEF_MIN ==> EXISTS(0, sizeof(predefinedNamespaces)/sizeof(predefinedNamespaces[0]), i, namespaceUri == predefinedNamespaces[i])) || (__out == -1 ==> FORALL(0, sizeof(predefinedNamespaces)/sizeof(predefinedNamespaces[0]), i, namespaceUri != predefinedNamespaces[i]))
