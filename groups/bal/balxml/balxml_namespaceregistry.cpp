...
(EXISTS(0, ARRAY_LEN(predefinedNamespaces), i, namespaceUri == predefinedNamespaces[i]) ==> __out >= balxml::NamespaceRegistry::e_PREDEF_MIN) && (FORALL(0, ARRAY_LEN(predefinedNamespaces), i, namespaceUri != predefinedNamespaces[i]) ==> __out == -1)
