...
// requires: true
// ensures: __out != 0 && (str != 0 ==> __out == str) && (str == 0 ==> __out == "")
inline
...
// requires: url != nullptr && encoding != nullptr
// ensures: (__out == 0) || (__out != 0 && __out == heldReader()->open(&d_utf8StreamBuf, url, encoding)) || (__out < 0 && __out == d_utf8StreamBuf.errorStatus())
inline
