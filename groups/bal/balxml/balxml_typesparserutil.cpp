...
(__out == BAEXML_SUCCESS ==> (*result == true || *result == false)) && (__out == BAEXML_FAILURE ==> __out == -1)
...
(__out == BAEXML_SUCCESS ==> consumed == inputLength && errno == 0) && (__out == BAEXML_FAILURE ==> consumed != inputLength || errno != 0)
