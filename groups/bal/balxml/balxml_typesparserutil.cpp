...
/// Parse an unsigned long decimal string
(__out == BAEXML_SUCCESS ==> (*result ↦ bsl::strtoul(input, nullptr, 10) ⋆ SEPFORALL(0, inputLength, i, (input + i ↦ input[i])))) && (__out == BAEXML_FAILURE ==> SEPFORALL(0, inputLength, i, (input + i ↦ input[i])))
