...
// requires: (inputLength == 1 && (input[0] == '1' || input[0] == '0')) ==> true
...
// ensures: (__out == BAEXML_SUCCESS ==> (result != 0)) && (__out == BAEXML_FAILURE ==> true)
...
// requires: inputLength >= 0 && result != NULL
...
/// Parse an unsigned long decimal string
// requires: inputLength >= 0 && SEPFORALL(0, inputLength, i, input + i ↦ _) && (input + inputLength ↦ 0) && result != 0
// ensures: (__out == BAEXML_SUCCESS) && (__out == BAEXML_FAILURE ==> true)
