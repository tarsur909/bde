...
// ACCESSORS
// requires: true
// ensures: (__out == ErrorInfo::e_FATAL_ERROR && d_fatalError) || (__out == ErrorInfo::e_ERROR && d_errorCount != 0 && !d_fatalError) || (__out == ErrorInfo::e_WARNING && d_warningCount != 0 && d_errorCount == 0 && !d_fatalError) || (__out == ErrorInfo::e_NO_ERROR && d_warningCount == 0 && d_errorCount == 0 && !d_fatalError)
