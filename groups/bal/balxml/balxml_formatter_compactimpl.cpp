...
// CLASS METHODS
__out == stream && state->column() == 0 && ((old_state->id() == StateId::e_IN_TAG ==> state->id() == StateId::e_FIRST_DATA_BETWEEN_TAGS) || (old_state->id() != StateId::e_IN_TAG ==> state->id() == old_state->id()))
