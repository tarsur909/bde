...
// PRIVATE ACCESSORS
(__out == 0) || (__out == -1 ==> ((blockHdr->d_magic != k_ALLOCATED_BLOCK_MAGIC) || (this != blockHdr->d_allocator_p && blockHdr->d_allocator_p->d_magic == k_STACK_TRACE_TEST_ALLOCATOR_MAGIC) || (0 == d_blocks || 0 == blockHdr->d_prevNext_p || 0 == *blockHdr->d_prevNext_p) || (blockHdr->d_next_p && k_ALLOCATED_BLOCK_MAGIC != blockHdr->d_next_p->d_magic)))
