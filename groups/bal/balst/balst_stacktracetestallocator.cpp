...
// PRIVATE ACCESSORS
(__out == -1 ==> (blockHdr->d_magic != k_ALLOCATED_BLOCK_MAGIC || this != blockHdr->d_allocator_p || d_blocks == 0 || blockHdr->d_prevNext_p == 0 || *blockHdr->d_prevNext_p == 0 || (blockHdr->d_next_p != 0 && blockHdr->d_next_p->d_magic != k_ALLOCATED_BLOCK_MAGIC))) && (__out == 0 ==> (blockHdr->d_magic == k_ALLOCATED_BLOCK_MAGIC && this == blockHdr->d_allocator_p && d_blocks != 0 && blockHdr->d_prevNext_p != 0 && *blockHdr->d_prevNext_p != 0 && (blockHdr->d_next_p == 0 || blockHdr->d_next_p->d_magic == k_ALLOCATED_BLOCK_MAGIC)))
