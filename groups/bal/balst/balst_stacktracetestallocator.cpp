...
// PRIVATE ACCESSORS
// requires: blockHdr != nullptr && (blockHdr->d_magic == k_ALLOCATED_BLOCK_MAGIC || blockHdr->d_magic == k_DEALLOCATED_BLOCK_MAGIC) && blockHdr->d_allocator_p != nullptr && (blockHdr->d_prevNext_p == nullptr || *blockHdr->d_prevNext_p != nullptr) && (blockHdr->d_next_p == nullptr || blockHdr->d_next_p->d_magic == k_ALLOCATED_BLOCK_MAGIC || blockHdr->d_next_p->d_magic == k_DEALLOCATED_BLOCK_MAGIC)
