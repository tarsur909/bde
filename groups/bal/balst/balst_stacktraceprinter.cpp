...
// FREE OPERATORS
// requires: true
// ensures: (__out == &stream) && (stream + 0 ↦ bsl::endl ⋆ balst::StackTracePrintUtil::printStackTrace(stream, object.d_maxFrames, object.d_demanglingPreferredFlag, object.d_additionalIgnoreFrames + 1) == &stream)
