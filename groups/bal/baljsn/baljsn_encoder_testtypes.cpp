...
(this != &rhs ==> (d_street ↦ rhs.d_street ⋆ d_city ↦ rhs.d_city ⋆ d_state ↦ rhs.d_state)) && (this == &rhs ==> true)
EncoderTestAddress&
...
&__out == this && (rhs.d_selectionId == SELECTION_ID_SELECTION0 ==> d_selectionId == SELECTION_ID_SELECTION0) && (rhs.d_selectionId != SELECTION_ID_SELECTION0 ==> d_selectionId == SELECTION_ID_UNDEFINED)
...
(__out == 0 && (selectionId == SELECTION_ID_SELECTION0 || selectionId == SELECTION_ID_UNDEFINED)) || (__out == -1 && selectionId != SELECTION_ID_SELECTION0 && selectionId != SELECTION_ID_UNDEFINED)
...
(__out == -1 ==> selectionInfo == 0) && (__out != -1 ==> selectionInfo != 0 && __out == makeSelection(selectionInfo->d_id))
...
(SELECTION_ID_SELECTION0 == d_selectionId ==> (d_selection0.object() ↦ value)) && (SELECTION_ID_SELECTION0 != d_selectionId ==> (d_selection0.buffer() ↦ value ⋆ d_selectionId == SELECTION_ID_SELECTION0)) && (__out ↦ value)
...
(__out == 0 ==> (*result ↦ static_cast<EncoderTestChoiceWithAllCategoriesEnumeration::Value>(number) && (number == EncoderTestChoiceWithAllCategoriesEnumeration::A || number == EncoderTestChoiceWithAllCategoriesEnumeration::B))) && (__out == -1 ==> *result ↦ old_result)
...
(this != &rhs) ==> ((__out.d_selectionId == rhs.d_selectionId) ⋆ (__out.d_selectionId == SELECTION_ID_SELECTION0 ==> (__out.d_selection0.object() ↦ rhs.d_selection0.object())) ⋆ (__out.d_selectionId != SELECTION_ID_SELECTION0 ==> __out.d_selectionId == SELECTION_ID_UNDEFINED)) && (this == &rhs) ==> true
...
__out == *this && (this != &rhs ==> (d_selectionId == rhs.d_selectionId && ((d_selectionId == SELECTION_ID_CHAR_ARRAY && d_charArray.object() == rhs.d_charArray.object()) || (d_selectionId == SELECTION_ID_CHOICE && d_choice.object() == rhs.d_choice.object()) || (d_selectionId == SELECTION_ID_CUSTOMIZED_TYPE && d_customizedType.object() == rhs.d_customizedType.object()) || (d_selectionId == SELECTION_ID_ENUMERATION && d_enumeration.object() == rhs.d_enumeration.object()) || (d_selectionId == SELECTION_ID_SEQUENCE && d_sequence.object() == rhs.d_sequence.object()) || (d_selectionId == SELECTION_ID_SIMPLE && d_simple.object() == rhs.d_simple.object()))))
...
(__out == 0) || (__out == -1 && selectionId != SELECTION_ID_CHAR_ARRAY && selectionId != SELECTION_ID_CHOICE && selectionId != SELECTION_ID_CUSTOMIZED_TYPE && selectionId != SELECTION_ID_ENUMERATION && selectionId != SELECTION_ID_SEQUENCE && selectionId != SELECTION_ID_SIMPLE && selectionId != SELECTION_ID_UNDEFINED)
...
(__out == -1 ==> selectionInfo == 0) && (__out != -1 ==> selectionInfo != 0)
...
(d_selectionId == SELECTION_ID_ENUMERATION) && (d_enumeration.object() == value)
...
(SELECTION_ID_SIMPLE == d_selectionId ==> (d_simple.object() ↦ value)) && (SELECTION_ID_SIMPLE != d_selectionId ==> (d_simple.buffer() ↦ value ⋆ d_selectionId ↦ SELECTION_ID_SIMPLE))
...
(__out == 0 ==> (selectionId == SELECTION_ID_SEQUENCE || selectionId == SELECTION_ID_UNDEFINED)) && (__out == -1 ==> (selectionId != SELECTION_ID_SEQUENCE && selectionId != SELECTION_ID_UNDEFINED))
