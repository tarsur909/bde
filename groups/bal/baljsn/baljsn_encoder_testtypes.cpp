...
__out.d_street ↦ rhs.d_street ⋆ __out.d_city ↦ rhs.d_city ⋆ __out.d_state ↦ rhs.d_state
EncoderTestAddress&
...
(this != &rhs ==> (__out.d_selectionId == rhs.d_selectionId && (__out.d_selectionId == SELECTION_ID_SELECTION0 ==> (__out.d_selection0.object() == rhs.d_selection0.object())))) && (this == &rhs ==> true)
...
d_selectionId == SELECTION_ID_SELECTION0 && (__out ↦ value)
...
(__out == 0 ==> (*result ↦ static_cast<EncoderTestSequenceWithAllCategoriesEnumeration::Value>(number))) && (__out == -1 ==> (number != EncoderTestSequenceWithAllCategoriesEnumeration::A && number != EncoderTestSequenceWithAllCategoriesEnumeration::B))
...
__out == *this && (__out.d_selectionId == rhs.d_selectionId)
...
(d_selectionId == SELECTION_ID_ENUMERATION ==> __out == value) && (d_selectionId != SELECTION_ID_ENUMERATION ==> (d_selectionId == SELECTION_ID_ENUMERATION ⋆ __out == value))
...
__out != 0 && (__out == SELECTION_INFO_ARRAY[SELECTION_INDEX_CHAR_ARRAY].name() || __out == SELECTION_INFO_ARRAY[SELECTION_INDEX_CHOICE].name() || __out == SELECTION_INFO_ARRAY[SELECTION_INDEX_CUSTOMIZED_TYPE].name() || __out == SELECTION_INFO_ARRAY[SELECTION_INDEX_ENUMERATION].name() || __out == SELECTION_INFO_ARRAY[SELECTION_INDEX_SEQUENCE].name() || __out == SELECTION_INFO_ARRAY[SELECTION_INDEX_SIMPLE].name() || __out == "(* UNDEFINED *)")
...
(this != &rhs ==> (d_charArray == rhs.d_charArray ⋆ d_aString == rhs.d_aString ⋆ d_array == rhs.d_array ⋆ d_choice == rhs.d_choice ⋆ d_customizedType == rhs.d_customizedType ⋆ d_enumeration == rhs.d_enumeration ⋆ d_nullableValue == rhs.d_nullableValue ⋆ d_sequence == rhs.d_sequence ⋆ d_simple == rhs.d_simple)) && (this == &rhs)
