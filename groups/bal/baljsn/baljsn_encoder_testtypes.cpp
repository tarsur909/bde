...
(__out == 0 ==> SEPEXISTS(0, 2, i, (stringLength == ENUMERATOR_INFO_ARRAY[i].d_nameLength && 0 == bsl::memcmp(ENUMERATOR_INFO_ARRAY[i].d_name_p, string, stringLength)) && (*result ↦ static_cast<EncoderTestChoiceWithAllCategoriesEnumeration::Value>(ENUMERATOR_INFO_ARRAY[i].d_value)))) && (__out == -1 ==> *result ↦ old_result)
...
(d_selectionId == SELECTION_ID_ENUMERATION) && ((old_d_selectionId == SELECTION_ID_ENUMERATION ==> (d_enumeration.object() == value)) && (old_d_selectionId != SELECTION_ID_ENUMERATION ==> (d_enumeration.object() == value))) && (__out == d_enumeration.object())
...
(this != &rhs ==> ((rhs.d_selectionId == SELECTION_ID_SEQUENCE ==> (d_selectionId == SELECTION_ID_SEQUENCE ⋆ d_sequence.object() == rhs.d_sequence.object())) || (rhs.d_selectionId == SELECTION_ID_UNDEFINED ==> (d_selectionId == SELECTION_ID_UNDEFINED)))) && (this == &rhs ==> true)
