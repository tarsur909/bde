...
(selectionInfo == 0 ==> __out == -1) && (selectionInfo != 0 ==> __out != -1)
...
(number == EncoderTestChoiceWithAllCategoriesEnumeration::A || number == EncoderTestChoiceWithAllCategoriesEnumeration::B) ==> __out == 0 && (number != EncoderTestChoiceWithAllCategoriesEnumeration::A && number != EncoderTestChoiceWithAllCategoriesEnumeration::B) ==> __out == -1
...
(__out == 0 ==> *result != EncoderTestChoiceWithAllCategoriesEnumeration::Value::UNSET) && (__out == -1 ==> *result == EncoderTestChoiceWithAllCategoriesEnumeration::Value::UNSET)
...
(__out == 0 ==> (*result == EncoderTestSequenceWithAllCategoriesEnumeration::A || *result == EncoderTestSequenceWithAllCategoriesEnumeration::B)) && (__out == -1 ==> (*result != EncoderTestSequenceWithAllCategoriesEnumeration::A && *result != EncoderTestSequenceWithAllCategoriesEnumeration::B))
...
(__out == 0 ==> result != nullptr) && (__out == -1 ==> result == nullptr || result != nullptr)
