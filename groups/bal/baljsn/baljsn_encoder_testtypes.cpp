...
(this != &rhs) ==> ((rhs.d_selectionId == SELECTION_ID_SELECTION0) ==> (d_selectionId == SELECTION_ID_SELECTION0 ⋆ d_selection0.object() ↦ rhs.d_selection0.object()) ⋆ (rhs.d_selectionId == SELECTION_ID_UNDEFINED) ==> (d_selectionId == SELECTION_ID_UNDEFINED && d_selection0.object() ↦ _))
...
(d_selectionId == SELECTION_ID_SELECTION0 ==> __out == SELECTION_INFO_ARRAY[SELECTION_INDEX_SELECTION0].name()) && (d_selectionId == SELECTION_ID_UNDEFINED ==> __out == "(* UNDEFINED *)")
...
d_selectionId == SELECTION_ID_SIMPLE && (__out ↦ value)
...
(this != &rhs ==> ((d_selectionId == SELECTION_ID_SEQUENCE && d_sequence.object() == rhs.d_sequence.object()) ⋆ (d_selectionId == SELECTION_ID_UNDEFINED ==> __out == *this))) && (this == &rhs ==> true)
...
(this != &rhs ==> (d_name ↦ rhs.d_name ⋆ d_homeAddress ↦ rhs.d_homeAddress ⋆ d_age ↦ rhs.d_age)) && (this == &rhs ==> true)
EncoderTestEmployee&
