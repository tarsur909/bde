...
(this != &rhs) ==> ((__out.d_selectionId == rhs.d_selectionId) ⋆ (__out.d_selectionId == SELECTION_ID_SELECTION0 ==> (__out.d_selection0.object() == rhs.d_selection0.object())) ⋆ (__out.d_selectionId == SELECTION_ID_UNDEFINED ==> true)) && (this == &rhs ==> true)
...
(__out == -1 ==> (selectionId != SELECTION_ID_SELECTION0 && selectionId != SELECTION_ID_UNDEFINED)) && (__out == 0 ==> (selectionId == SELECTION_ID_SELECTION0 || selectionId == SELECTION_ID_UNDEFINED))
...
(d_selectionId == SELECTION_ID_SELECTION0 ==> (d_selection0.object() ↦ value)) && (d_selectionId != SELECTION_ID_SELECTION0 ==> (d_selection0.buffer() ↦ value ⋆ d_selectionId == SELECTION_ID_SELECTION0)) ⋆ (__out == d_selection0.object())
...
(this != &rhs) ==> ((__out.d_selectionId == rhs.d_selectionId) ⋆ ((rhs.d_selectionId == SELECTION_ID_SELECTION0) ==> (__out.d_selection0.object() ↦ rhs.d_selection0.object())) ⋆ ((rhs.d_selectionId != SELECTION_ID_SELECTION0) ==> true)) && (this == &rhs) ==> true
...
(d_selectionId == SELECTION_ID_SELECTION0 ==> (d_selection0.object() ↦ value)) && (d_selectionId != SELECTION_ID_SELECTION0 ==> (d_selection0.buffer() ↦ value ⋆ d_selectionId ↦ SELECTION_ID_SELECTION0))
...
(__out == 0 ==> EXISTS(0, 2, i, (stringLength == EncoderTestSequenceWithAllCategoriesEnumeration::ENUMERATOR_INFO_ARRAY[i].d_nameLength && 0 == bsl::memcmp(EncoderTestSequenceWithAllCategoriesEnumeration::ENUMERATOR_INFO_ARRAY[i].d_name_p, string, stringLength) && (*result ↦ static_cast<EncoderTestSequenceWithAllCategoriesEnumeration::Value>(EncoderTestSequenceWithAllCategoriesEnumeration::ENUMERATOR_INFO_ARRAY[i].d_value))))) && (__out == -1 ==> FORALL(0, 2, i, (stringLength != EncoderTestSequenceWithAllCategoriesEnumeration::ENUMERATOR_INFO_ARRAY[i].d_nameLength || 0 != bsl::memcmp(EncoderTestSequenceWithAllCategoriesEnumeration::ENUMERATOR_INFO_ARRAY[i].d_name_p, string, stringLength))))
...
(__out == 0 ==> (selectionId == SELECTION_ID_CHAR_ARRAY || selectionId == SELECTION_ID_CHOICE || selectionId == SELECTION_ID_CUSTOMIZED_TYPE || selectionId == SELECTION_ID_ENUMERATION || selectionId == SELECTION_ID_SEQUENCE || selectionId == SELECTION_ID_SIMPLE || selectionId == SELECTION_ID_UNDEFINED)) && (__out == -1 ==> !(selectionId == SELECTION_ID_CHAR_ARRAY || selectionId == SELECTION_ID_CHOICE || selectionId == SELECTION_ID_CUSTOMIZED_TYPE || selectionId == SELECTION_ID_ENUMERATION || selectionId == SELECTION_ID_SEQUENCE || selectionId == SELECTION_ID_SIMPLE || selectionId == SELECTION_ID_UNDEFINED))
...
(d_selectionId == SELECTION_ID_ENUMERATION ==> (d_enumeration.object() == value)) && (d_selectionId != SELECTION_ID_ENUMERATION ==> (d_selectionId == SELECTION_ID_ENUMERATION ⋆ d_enumeration.object() == value)) && (__out == d_enumeration.object())
...
(__out == *this) && (d_name ↦ rhs.d_name ⋆ d_homeAddress ↦ rhs.d_homeAddress ⋆ d_age ↦ rhs.d_age)
EncoderTestEmployee&
...
__out == *this ⋆ (d_charArray ↦ rhs.d_charArray) ⋆ (d_aString ↦ rhs.d_aString) ⋆ (d_array ↦ rhs.d_array) ⋆ (d_choice ↦ rhs.d_choice) ⋆ (d_customizedType ↦ rhs.d_customizedType) ⋆ (d_enumeration ↦ rhs.d_enumeration) ⋆ (d_nullableValue ↦ rhs.d_nullableValue) ⋆ (d_sequence ↦ rhs.d_sequence) ⋆ (d_simple ↦ rhs.d_simple)
