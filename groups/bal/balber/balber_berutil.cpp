...
// CLASS METHODS
// requires: true
// ensures: (value == 0 ==> __out == 1) && (value > 0 ==> __out == ((31 - bdlb::BitUtil::numLeadingUnsetBits(static_cast<bsl::uint32_t>(value)) + 2 + Constants::k_NUM_BITS_PER_OCTET - 1) / Constants::k_NUM_BITS_PER_OCTET)) && (value < 0 ==> __out == ((31 - bdlb::BitUtil::numLeadingUnsetBits(static_cast<bsl::uint32_t>(~value)) + 2 + Constants::k_NUM_BITS_PER_OCTET - 1) / Constants::k_NUM_BITS_PER_OCTET))
