...
// MANIPULATORS
// requires: true
// ensures: d_recordLevel ↦ rhs.d_recordLevel ⋆ d_passLevel ↦ rhs.d_passLevel ⋆ d_triggerLevel ↦ rhs.d_triggerLevel ⋆ d_triggerAllLevel ↦ rhs.d_triggerAllLevel
ThresholdAggregate&
...
// ACCESSORS
// requires: true
// ensures: __out == stream && (SEPFORALL(0, __out.str().size(), i, __out.str()[i] == __out.str()[i]))
bsl::ostream&
