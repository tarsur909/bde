...
// FREE OPERATORS
(__out == true ==> (lhs.numRules() == rhs.numRules() && FORALL(0, lhs.numRules(), i, EXISTS(0, rhs.numRules(), j, rhs.ruleId(*lhs.getRuleById(i)) == j)))) && (__out == false ==> (lhs.numRules() != rhs.numRules() || EXISTS(0, lhs.numRules(), i, 0 > rhs.ruleId(*lhs.getRuleById(i)))))
