...
// FREE OPERATORS
(__out == true ==> (lhs.numRules() == rhs.numRules() && FORALL(0, lhs.numRules(), i, rhs.ruleId(*lhs.getRuleById(i)) >= 0))) && (__out == false ==> (lhs.numRules() != rhs.numRules() || SEPEXISTS(0, lhs.numRules(), i, rhs.ruleId(*lhs.getRuleById(i)) < 0)))
