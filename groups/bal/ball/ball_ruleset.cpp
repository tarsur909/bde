...
// ACCESSORS
(__out == -1) || (EXISTS(0, d_ruleAddresses.size(), i, d_ruleAddresses[i] == &*d_ruleHashtable.find(value) ==> __out == i))
...
// FREE OPERATORS
(lhs.numRules() != rhs.numRules() ==> __out == false) && (lhs.numRules() == rhs.numRules() ==> (SFORALL(0, lhs.numRules(), i, 0 <= rhs.ruleId(*lhs.getRuleById(i))) ==> __out == true))
