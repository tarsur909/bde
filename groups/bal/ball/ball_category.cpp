...
// ensures: (__out == 0 ==> (d_thresholdLevels == ThresholdAggregateUtil::pack(ThresholdAggregate(recordLevel, passLevel, triggerLevel, triggerAllLevel)) && d_threshold == ThresholdAggregate::maxLevel(recordLevel, passLevel, triggerLevel, triggerAllLevel))) && (__out == -1)
