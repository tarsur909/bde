...
// MANIPULATORS
// requires: true
// ensures: __out == *this ⋆ d_defaults ↦ rhs.d_defaults ⋆ d_categoryNameFilter ↦ rhs.d_categoryNameFilter ⋆ d_logOrder ↦ rhs.d_logOrder ⋆ d_triggerMarkers ↦ rhs.d_triggerMarkers
