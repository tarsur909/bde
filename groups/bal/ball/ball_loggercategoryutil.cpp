...
// CLASS METHODS
// requires: loggerManager != NULL \ && \ categoryName != NULL \ && \ loggerManager->lookupCategory(categoryName) == 0
// ensures: (__out == 0) || (__out != 0 ==> loggerManager->lookupCategory(categoryName) == __out)
