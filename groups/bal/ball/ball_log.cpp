...
// CLASS METHODS
(__out >= 0 && __out < numBytes ==> (SEPFORALL(0, __out, i, (buffer + i ↦ format[i])) && (buffer + __out ↦ 0))) && (__out >= 0 && __out >= numBytes ==> SEPFORALL(0, numBytes, i, (buffer + i ↦ format[i]))) && (__out == -1 ==> SEPFORALL(0, numBytes, i, (buffer + i ↦ _)))
