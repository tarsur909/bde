...
// MANIPULATORS
(this != &rhs ==> __out.d_attributeSet == rhs.d_attributeSet) && (this == &rhs ==> __out.d_attributeSet == __out.d_attributeSet)
ManagedAttributeSet&
...
// ACCESSORS
(__out == true ==> FORALL(this->begin(), this->end(), iter, containerList.hasValue(iter->attribute()))) && (__out == false ==> EXISTS(this->begin(), this->end(), iter, !containerList.hasValue(iter->attribute())))
bool
...
// FREE OPERATORS
((lhs.numAttributes() == rhs.numAttributes() && FORALL(0, lhs.numAttributes(), i, rhs.isMember(*(lhs.begin() + i)))) ==> __out == true) && ((lhs.numAttributes() != rhs.numAttributes() || EXISTS(0, lhs.numAttributes(), i, !rhs.isMember(*(lhs.begin() + i)))) ==> __out == false)
