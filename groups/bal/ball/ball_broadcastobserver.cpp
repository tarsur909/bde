...
// MANIPULATORS
(__out == 1 ==> d_observers.find(observerName) == d_observers.end()) && (__out == 0 ==> (d_observers.find(observerName) == d_observers.end() && old_d_observers.find(observerName) != d_observers.end()))
