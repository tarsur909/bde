...
__out == bsl::string(buffer) && buffer == std::to_string(timestamp.year()) + std::string(timestamp.month() < 10 ? "0" : "") + std::to_string(timestamp.month()) + std::string(timestamp.day() < 10 ? "0" : "") + std::to_string(timestamp.day()) + "_" + std::string(timestamp.hour() < 10 ? "0" : "") + std::to_string(timestamp.hour()) + std::string(timestamp.minute() < 10 ? "0" : "") + std::to_string(timestamp.minute()) + std::string(timestamp.second() < 10 ? "0" : "") + std::to_string(timestamp.second())
