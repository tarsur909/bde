...
// CLASS METHODS
(__out == rule.d_hashValue) && (rule.d_hashValue >= 0) && (rule.d_hashSize == size) && ((rule.d_hashValue ↦ _ ⋆ rule.d_hashSize ↦ _) || (rule.d_hashValue < 0 && rule.d_hashSize != size) ==> (rule.d_hashValue >= 0 && rule.d_hashSize == size))
