...
// MANIPULATORS
(__out == -1 ==> SEPEXISTS(0, v.size(), i, !(v[i].value().isString()))) && (__out == 0 ==> (SEPFORALL(0, v.size(), i, v[i].value().isString()) && (FORALL(0, v.size(), i, (v[i].key() == k_KEY_NAME) ==> (d_name ↦ v[i].value().theString())))))
...
// MANIPULATORS
(__out == -1 ==> format.empty()) && (__out != -1 ==> (__out == 0 ==> (d_formatSpec ↦ format ⋆ d_fieldFormatters ↦ _)) && (__out != 0 ==> true))
