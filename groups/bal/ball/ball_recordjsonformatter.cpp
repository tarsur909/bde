...
// CLASS METHODS
(k_KEY_TIMESTAMP == v || k_KEY_PROCESS_ID == v || k_KEY_THREAD_ID == v || k_KEY_SEVERITY == v || k_KEY_FILE == v || k_KEY_LINE == v || k_KEY_CATEGORY == v || k_KEY_MESSAGE == v || k_KEY_ATTRIBUTES == v || d_skipAttributes_sp->find(v) != d_skipAttributes_sp->end()) ==> __out != NULL
