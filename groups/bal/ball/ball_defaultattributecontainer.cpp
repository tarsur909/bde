...
// MANIPULATORS
(this != &rhs ==> (FORALL(rhs.begin(), rhs.end(), iter, SEPEXISTS(__out.begin(), __out.end(), iter2, *iter2 == *iter)))) && (this == &rhs ==> true)
...
// FREE OPERATORS
(lhs.numAttributes() != rhs.numAttributes() ==> __out == false) && (lhs.numAttributes() == rhs.numAttributes() && std::equal(lhs.begin(), lhs.end(), rhs.begin()) ==> __out == true)
