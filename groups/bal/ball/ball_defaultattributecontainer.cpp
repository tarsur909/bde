...
// FREE OPERATORS
// requires: true
// ensures: (__out == true ==> (lhs.numAttributes() == rhs.numAttributes() && SEPFORALL(lhs.begin(), lhs.end(), iter, rhs.hasValue(*iter)))) && (__out == false ==> (lhs.numAttributes() != rhs.numAttributes() || SEPEXISTS(lhs.begin(), lhs.end(), iter, !rhs.hasValue(*iter))))
