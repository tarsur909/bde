...
// CLASS METHODS
(transmissionCause == Transmission::e_PASSTHROUGH && __out == (recordIndex == 0 && sequenceLength == 1)) || (transmissionCause != Transmission::e_PASSTHROUGH && (__out == (0 <= recordIndex && 1 <= sequenceLength && recordIndex < sequenceLength) || __out == false))
