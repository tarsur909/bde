...
// CLASS METHODS
(attribute.d_hashValue < 0 || attribute.d_hashSize != size) ==> (__out == attribute.d_hashValue % size && attribute.d_hashValue == __out && attribute.d_hashSize == size) && (0 <= __out && __out < size)
