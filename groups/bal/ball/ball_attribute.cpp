...
// CLASS METHODS
(attribute.d_hashValue < 0 || attribute.d_hashSize != size) ==> (attribute.d_hashValue ↦ _ ⋆ attribute.d_hashSize ↦ size) && (__out == attribute.d_hashValue)
...
// FREE OPERATORS
__out == output && (__out << attribute) == __out
