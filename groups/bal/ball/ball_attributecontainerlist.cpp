...
// FREE OPERATORS
(lhs.numContainers() != rhs.numContainers() ==> __out == false) && (lhs.numContainers() == rhs.numContainers() ==> FORALL(0, lhs.numContainers(), i, *std::next(lhs.begin(), i) == *std::next(rhs.begin(), i)))
