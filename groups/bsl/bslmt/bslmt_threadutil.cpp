...
// CLASS METHODS
(getMinSchedulingPriority(policy) == ThreadAttributes::e_UNSET_PRIORITY || getMaxSchedulingPriority(policy) == ThreadAttributes::e_UNSET_PRIORITY) ==> __out == ThreadAttributes::e_UNSET_PRIORITY
