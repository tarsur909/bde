...
__out != 0 && (__out == reinterpret_cast<TlsKey *>(bsls::AtomicOperations::getPtr(&s_semaphoreKey)) || (bsls::AtomicOperations::getPtr(&s_semaphoreKey) == 0 && __out == initializeSemaphoreTLSKey()))
inline
...
__out != 0 && (__out == s_semaphore ==> s_semaphore != 0) && (__out == bslmt::ThreadUtil::getSpecific(*getSemaphoreTLSKey()) ==> bslmt::ThreadUtil::getSpecific(*getSemaphoreTLSKey()) != 0)
