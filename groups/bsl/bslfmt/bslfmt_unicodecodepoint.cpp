...
/// return the result.
(__out == true ==> ((data[0] == 0xfe && data[1] == 0xff) || (data[0] == 0xff && data[1] == 0xfe) || (data[0] == 0xef && data[1] == 0xbb && data[2] == 0xbf) || (data[0] == 0x00 && data[1] == 0x00 && data[2] == 0xfe && data[3] == 0xff))) && (__out == false ==> SEPFORALL(0, maxBytes, i, (data + i ↦ _ && !(data[0] == 0xfe && data[1] == 0xff) && !(data[0] == 0xff && data[1] == 0xfe) && !(data[0] == 0xef && data[1] == 0xbb && data[2] == 0xbf) && !(data[0] == 0x00 && data[1] == 0x00 && data[2] == 0xfe && data[3] == 0xff))))
inline
...
/// describing a single valid code point.
__out == (((*pc & 0x7) << 18) | ((pc[1] & k_UTF8_CONT_VALUE_MASK) << 12) | ((pc[2] & k_UTF8_CONT_VALUE_MASK) << 6) | ((pc[3] & k_UTF8_CONT_VALUE_MASK)))
inline
