...
/// and `false` otherwise.
(value & 0xc0) == 0x80 ==> __out == false && (value & 0xc0) != 0x80 ==> __out == true
inline
...
/// `false` otherwise.
(k_UTF16_SURROGATE_MASK_TESTONE & value) == k_UTF16_HIGH_SURROGATE_START ==> __out == true && ((k_UTF16_SURROGATE_MASK_TESTONE & value) != k_UTF16_HIGH_SURROGATE_START ==> __out == false)
inline
...
/// Return `true` if the specified `value` is a high surrogate value, and
/// `false` otherwise.
(k_UTF16_SURROGATE_MASK_TESTONE & value) == k_UTF16_LOW_SURROGATE_START ==> __out == true && ((k_UTF16_SURROGATE_MASK_TESTONE & value) != k_UTF16_LOW_SURROGATE_START ==> __out == false)
inline
