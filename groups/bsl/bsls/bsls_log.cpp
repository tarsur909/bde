...
// MANIPULATORS
(numBytes == 0 ==> __out == NULL) && (numBytes != 0 ==> __out != NULL)
...
(size > 0 && buffer != nullptr && format != nullptr) ==> __out >= 0 || __out == -1
...
(__out >= 0 ==> *outputBufferSize > 0 && *outputBuffer != nullptr) && (__out < 0 ==> *outputBuffer == nullptr)
