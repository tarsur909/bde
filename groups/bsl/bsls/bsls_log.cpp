...
// MANIPULATORS
(d_buffer_p == 0 ==> numBytes == 0) && (d_buffer_p != 0 ==> (d_buffer_p ↦ _ ⋆ SFORALL(0, numBytes, i, d_buffer_p + i ↦ _))) && __out == d_buffer_p
...
(__out >= 0 || __out == -1) && (__out >= 0 ==> SFORALL(0, __out, i, buffer[i] ↦ _)) && (__out < size ==> buffer[__out] == 0)
