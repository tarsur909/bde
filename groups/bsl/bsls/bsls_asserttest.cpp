...
// ACCESSORS
(__out == true ==> (d_str_p == 0 && d_length == 0)) && (__out == false ==> (d_str_p != 0 || d_length != 0))
...
(__out == true ==> (lhs.length() == rhs.length() && 0 == memcmp(lhs.str(), rhs.str(), lhs.length()))) && (__out == false ==> !(lhs.length() == rhs.length() && 0 == memcmp(lhs.str(), rhs.str(), lhs.length())))
...
(__out == true ==> (testName.isEmpty() || throwName.isEmpty() || throwName == testName)) && (__out == false ==> !(testName.isEmpty() || throwName.isEmpty() || throwName == testName))
static
