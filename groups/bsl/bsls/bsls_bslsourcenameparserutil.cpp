...
/// than `end`.
(__out >= begin && __out <= end) && (__out != begin ==> *(__out - 1) == ch)
static
inline
...
__out == ((sourceType & BslSourceNameParserUtil::k_MASK_TEST) != 0)
static
inline
...
FORALL(0, strlen(__out), i, strchr(pathSeparators, __out[i]) == nullptr)
static
