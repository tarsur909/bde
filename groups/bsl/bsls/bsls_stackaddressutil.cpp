...
(__out != 0 ==> EXISTS(0, strlen(plink_timestamp___), i, (strchr(plink_timestamp___[i], ']') != 0 && strncmp(plink_timestamp___[i] + (strchr(plink_timestamp___[i], ']') - plink_timestamp___[i] + 1), tag, strlen(tag)) == 0))) && (__out == 0 ==> FORALL(0, strlen(plink_timestamp___), i, (strchr(plink_timestamp___[i], ']') == 0 || strncmp(plink_timestamp___[i] + (strchr(plink_timestamp___[i], ']') - plink_timestamp___[i] + 1), tag, strlen(tag)) != 0)))
