...
/// advanced).
(__out == true ==> (*iter != end && SEPFORALL(old_iter, *iter, i, (i ↦ _) && bdlb::CharType::isDigit(*i)))) && (__out == false ==> SEPEXISTS(old_iter, *iter, i, (i ↦ _) && !bdlb::CharType::isDigit(*i)))
...
/// algorithm.
(__out != end ==> !bdlb::CharType::isDigit(*__out)) && (__out == end ==> SEPFORALL(begin, end, i, bdlb::CharType::isDigit(*(i))))
