...
(lhs.d_isExpNegative != rhs.d_isExpNegative ==> __out == false) && (lhs.d_significantDigits != rhs.d_significantDigits ==> __out == false) && ((lhs.d_isExpNegative == rhs.d_isExpNegative && lhs.d_significantDigits == rhs.d_significantDigits) ==> __out == (lhs.d_exponent == rhs.d_exponent))
