...
/// advanced).
(__out == true ==> (*iter == end || !bdlb::CharType::isDigit(**iter)) && SEPFORALL(old_iter, *iter, i, (i ↦ _) && bdlb::CharType::isDigit(*i))) && (__out == false ==> SEPEXISTS(old_iter, *iter, i, (i ↦ _) && !bdlb::CharType::isDigit(*i)))
