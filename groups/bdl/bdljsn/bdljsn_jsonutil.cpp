...
(__out == 0 ==> result->size() >= old_result->size()) && (__out != 0 ==> error != nullptr)
...
(__out == 0 ==> (result->type() == JsonType::e_NULL || result->isBoolean() || result->isString() || result->isNumber())) && (__out != 0 ==> true)
...
// CLASS METHODS
(__out == 0 ==> (result != 0 ⋆ errorDescription != 0)) ⋆ (__out != 0 ==> errorDescription != 0)
