...
// requires: tokenizer->tokenType() != Tokenizer::e_ERROR && maxNestedDepth >= 0 && result != nullptr && error != nullptr
// ensures: (__out == 0 ==> (tokenizer->tokenType() == Tokenizer::e_END_ARRAY)) && (__out != 0 ==> error != nullptr)
...
// requires: result != nullptr && error != nullptr && tokenizer != nullptr
