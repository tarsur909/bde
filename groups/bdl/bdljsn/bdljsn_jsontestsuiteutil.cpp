...
__out != 0 && SEPFORALL(0, 50000, i, (__out + i * lenOpenArrayObjectSubsequence) ↦ openArrayObjectSubsequence) && (__out + 50000 * lenOpenArrayObjectSubsequence) ↦ "\n"
...
// ACCESSORS
__out == &s_data[index] && (__out->d_JSON_p ↦ _ ⋆ __out->d_length ↦ _)
