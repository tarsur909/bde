...
__out != 0 && SFORALL(0, 100000, i, (__out[i] == '['))
...
// ACCESSORS
__out != 0 && (__out == &s_data[index] ⋆ (index == 68 ==> (__out->d_JSON_p ↦ u::leftBrackets100000 ⋆ __out->d_length ↦ u::lenLeftBrackets100000)) ⋆ (index != 68 ==> (__out->d_JSON_p ↦ _ ⋆ __out->d_length ↦ _)))
