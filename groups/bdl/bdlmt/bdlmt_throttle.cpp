...
// ACCESSOR
// requires: (numActions > 0 && result != 0) || (numActions <= 0)
// ensures: (__out == -1 ==> (numActions <= 0 || d_maxSimultaneousActions < numActions || k_ALLOW_NONE == d_nanosecondsPerAction)) && (__out == 0 ==> (result != nullptr))
