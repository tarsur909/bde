...
// ACCESSORS
(__out >= 0 && __out <= d_capacity) && (__out == 0 || __out == static_cast<bsl::size_t>(combinedPushIndex - combinedPopIndex) || __out == bsl::min(static_cast<bsl::size_t>(combinedPushIndex - combinedPopIndex + d_maxCombinedIndex + 1), d_capacity))
