...
// STATIC METHODS
(__out == ((totalSize + (bsls::AlignmentUtil::BSLS_MAX_ALIGNMENT - 1)) & ~(bsls::AlignmentUtil::BSLS_MAX_ALIGNMENT - 1))) && (bsls::AlignmentUtil::BSLS_MAX_ALIGNMENT == bsls::AlignmentUtil::calculateAlignmentFromSize(__out))
static inline
