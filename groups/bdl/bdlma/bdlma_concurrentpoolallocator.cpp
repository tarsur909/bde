...
// STATIC METHODS
// requires: true
// ensures: __out == ((totalSize + (BloombergLP::bsls::AlignmentUtil::BSLS_MAX_ALIGNMENT - 1)) & ~(BloombergLP::bsls::AlignmentUtil::BSLS_MAX_ALIGNMENT - 1)) && (BloombergLP::bsls::AlignmentUtil::BSLS_MAX_ALIGNMENT == BloombergLP::bsls::AlignmentUtil::calculateAlignmentFromSize(__out))
static inline
...
// MANIPULATORS
// requires: size >= 0
// ensures: (__out == 0 ==> size == 0) && (__out != 0 ==> (__out ↦ _ ⋆ SEPFORALL(0, size, i, __out + i ↦ _)))
