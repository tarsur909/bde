...
// requires: size > 0
// ensures: (__out != 0 ==> (__out ↦ _ ⋆ SEPFORALL(0, size, i, (__out + i) ↦ _))) && (__out == 0 ==> true)
...
// requires: address != nullptr && pageSize == getSystemPageSize()
// ensures: true
...
// MANIPULATORS
// requires: (size == 0) ==> res_tmp == 0 && (size > 0) ==> res_tmp != 0
