...
// requires: size > 0
// ensures: (__out == 0 ==> false) && (__out != 0 ==> (__out ↦ _ ⋆ SEPFORALL(0, size, i, (__out + i) ↦ _)))
...
// requires: address != 0 && pageSize == pageSize
// ensures: (__out == 0) ==> (address != 0 && pageSize == getSystemPageSize())
