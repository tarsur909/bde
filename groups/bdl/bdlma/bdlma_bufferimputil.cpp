...
// ensures: (__out != 0) && (__out >= buffer) && (__out + size <= buffer + bufferSize) && (static_cast<bsls::Types::size_type>(old_cursor) <= static_cast<bsls::Types::size_type>(*cursor)) && (static_cast<bsls::Types::size_type>(*cursor) <= bufferSize)
