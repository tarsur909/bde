...
/// ```
// requires: base >= 1
// ensures: __out == *number / base && *number == initial % base && initial == *number + __out * base
static
...
// PRIVATE ACCESSORS
// requires: true
// ensures: (BSLS_PLATFORM_IS_LITTLE_ENDIAN ? __out == d_value * TimeUnitRatio::k_US_PER_MS : __out == (d_value >> 32) * TimeUnitRatio::k_US_PER_MS)
