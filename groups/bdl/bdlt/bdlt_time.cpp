...
// ensures: (__out == initial / base) && (*number == initial % base) && (initial == *number + __out * base)
static
...
// requires: base > 0 && number != nullptr
// ensures: (__out == (old_number / base)) && (0 <= *number) && (*number < base)
static
