...
// HELPER FUNCTIONS
(__out >= 0 && __out < numBytes) || (__out >= 0 && __out >= numBytes)
...
// CLASS METHODS
(!(u::k_HOURS_CEILING < hours || u::k_MINUTES_CEILING < minutes || u::k_SECONDS_CEILING < seconds || u::k_MILLISECONDS_CEILING < milliseconds || u::k_HOURS_FLOOR > hours || u::k_MINUTES_FLOOR > minutes || u::k_SECONDS_FLOOR > seconds || u::k_MILLISECONDS_FLOOR > milliseconds) && __out == true) || (__out == false)
