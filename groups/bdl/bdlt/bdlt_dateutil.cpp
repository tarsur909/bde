...
(__out.month() == 2) && (__out.year() == original.year() + numYears) && ((original.day() == 28 ==> __out.day() == 28) || (original.day() == 29 ==> (__out.day() == 29 && SerialDateImpUtil::isLeapYear(__out.year())) || (__out.day() == 28 && !SerialDateImpUtil::isLeapYear(__out.year()))))
...
// CLASS METHODS
(__out.year() == (original.year() * 12 + original.month() + numMonths - 1) / 12) && (__out.month() == ((original.year() * 12 + original.month() + numMonths - 1) % 12 + 1)) && ((__out.day() == SerialDateImpUtil::lastDayOfMonth(__out.year(), __out.month())) || (__out.day() == original.day()))
