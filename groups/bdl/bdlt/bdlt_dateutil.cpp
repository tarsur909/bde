...
/// specified `day2`.
// requires: 0 <= day1 && day1 <= 6 && 0 <= day2 && day2 <= 6
...
// ensures: (__out.month() == 2) && (__out.year() == original.year() + numYears) && ((original.day() == 28 ==> __out.day() == 28) || (original.day() == 29 ==> (__out.day() == 29 && SerialDateImpUtil::isLeapYear(__out.year()))))
...
// CLASS METHODS
// requires: (1 <= original.year() && original.year() <= 9999) && (1 <= original.month() && original.month() <= 12) && (1 <= original.day() && original.day() <= SerialDateImpUtil::lastDayOfMonth(original.year(), original.month()))
// ensures: (original.day() == SerialDateImpUtil::lastDayOfMonth(original.year(), original.month()) || __out.day() == original.day() || __out.day() == SerialDateImpUtil::lastDayOfMonth(__out.year(), __out.month())) && (__out.year() * 12 + __out.month() == original.year() * 12 + original.month() + numMonths)
