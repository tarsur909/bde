...
/// specified `day2`.
(day1 > day2 ==> __out == 7 - day1 + day2) && (day1 <= day2 ==> __out == day2 - day1) && (0 <= __out && __out < 7)
...
(__out.year() == original.year() + numYears) && (__out.month() == 2) && ((__out.day() == original.day()) || (__out.day() == (SerialDateImpUtil::isLeapYear(__out.year()) ? 29 : 28)))
...
// CLASS METHODS
(original.day() == SerialDateImpUtil::lastDayOfMonth(original.year(), original.month()) ==> __out.day() == SerialDateImpUtil::lastDayOfMonth(__out.year(), __out.month())) && (original.day() != SerialDateImpUtil::lastDayOfMonth(original.year(), original.month()) && SerialDateImpUtil::lastDayOfMonth(__out.year(), __out.month()) < original.day() ==> __out.day() == SerialDateImpUtil::lastDayOfMonth(__out.year(), __out.month())) && (original.day() != SerialDateImpUtil::lastDayOfMonth(original.year(), original.month()) && SerialDateImpUtil::lastDayOfMonth(__out.year(), __out.month()) >= original.day() ==> __out.day() == original.day())
