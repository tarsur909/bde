...
/// specified `day2`.
__out >= 0 && ((day1 > day2) ==> (__out == 7 - day1 + day2)) && ((day1 <= day2) ==> (__out == day2 - day1))
...
(__out.year() == original.year() + numYears && __out.month() == 2) && ((original.day() == 29 && SerialDateImpUtil::isLeapYear(original.year() + numYears) ==> __out.day() == 29) || (original.day() == 29 && !SerialDateImpUtil::isLeapYear(original.year() + numYears) ==> __out.day() == 28) || (original.day() == 28 ==> __out.day() == 28))
