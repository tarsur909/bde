...
// CLASS METHODS
(original.day() == SerialDateImpUtil::lastDayOfMonth(original.year(), original.month()) || SerialDateImpUtil::lastDayOfMonth(__out.year(), __out.month()) < original.day()) ==> __out.day() == SerialDateImpUtil::lastDayOfMonth(__out.year(), __out.month()) || (__out.day() == original.day())
