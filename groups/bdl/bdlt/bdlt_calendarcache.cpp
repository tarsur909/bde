...
// MANIPULATORS
(__out != nullptr) || (__out == nullptr && (!d_loader_p->load(&packedCalendar, calendarName) || (d_hasTimeOutFlag && d_timeOut <= CurrentTime::utc() - d_cache.find(calendarName)->second.loadTime())))
