...
(__out == 0 ==> *nextPos == end && *result >= 0) && (__out == -1 ==> EXISTS(begin, end, i, !isdigit(*(begin + i))))
...
/// error.
(__out == 0 ==> *nextPos != NULL) && (__out == -1 ==> *nextPos == NULL || *nextPos != NULL)
...
(__out == 0 ==> *nextPos != NULL) && (__out == -1 || __out == 0)
...
(tzOffset == 0 && configuration.useZAbbreviationForUtc() ==> __out == 1) && (tzOffset != 0 || !configuration.useZAbbreviationForUtc() ==> __out > 1)
