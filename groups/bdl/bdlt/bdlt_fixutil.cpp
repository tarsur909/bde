...
(__out == 0 ==> (*nextPos == begin || SEPFORALL(begin, *nextPos, p, (p ↦ _) && isdigit(*p)) ⋆ *microsecond == tmp)) && (__out == -1 ==> (*nextPos == old_nextPos ⋆ *microsecond == old_microsecond))
...
/// error.
(__out == 0 ==> (*nextPos > begin && *minuteOffset >= -1439 && *minuteOffset <= 1439)) && (__out == -1 ==> (*nextPos == begin || *minuteOffset == 0))
