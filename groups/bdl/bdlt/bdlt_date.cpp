...
// MANIPULATORS
// requires: bsl::numeric_limits<int>::max() - d_serialDate >= numDays && Date::isValidSerial(d_serialDate + numDays)
...
// ACCESSORS
// requires: !stream.bad()
// ensures: __out == stream && SEPFORALL(0, 128, i, (buffer + i ↦ sep_v) && (sep_v == buffer[i]))
