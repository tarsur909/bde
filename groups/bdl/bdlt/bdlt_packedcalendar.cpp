...
__out == stream && (__out.rdbuf()->invariant())
static
...
(0 <= offset && d_holidayOffsets.back() < offset) ==> __out == static_cast<int>(d_holidayOffsets.length()) && (0 <= offset && d_holidayOffsets.back() >= offset) ==> (0 <= __out && __out < static_cast<int>(d_holidayOffsets.length()))
