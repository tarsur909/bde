...
/// `lastDate < firstDate`.
__out == ((lastDate - firstDate + 1) / 7) * weekendDays.length() + (mySet.length())
static
...
// ACCESSORS
(__out != d_holidayCodes.begin() + d_holidayCodes.length()) || (__out == d_holidayCodes.begin() + d_holidayCodes.length())
