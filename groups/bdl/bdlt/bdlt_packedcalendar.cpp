...
/// `lastDate < firstDate`.
// requires: true
// ensures: (firstDate <= lastDate ==> __out >= 0 && __out <= (lastDate - firstDate + 1)) && (firstDate > lastDate ==> __out == 0)
static
...
// requires: offset >= 0
// ensures: (__out >= 0 && __out <= d_holidayOffsets.length()) && (__out == d_holidayOffsets.length() - 1 ==> d_holidayOffsets[__out] == offset) && (__out < d_holidayOffsets.length() - 1 ==> d_holidayOffsets[__out] <= offset && d_holidayOffsets[__out + 1] > offset)
