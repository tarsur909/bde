...
/// `lastDate < firstDate`.
__out >= 0 && __out <= (firstDate <= lastDate ? lastDate - firstDate + 1 : 0)
static
...
EXISTS(0, d_holidayOffsets.length(), i, d_holidayOffsets[i] == offset) && __out >= 0 && __out < static_cast<int>(d_holidayOffsets.length())
