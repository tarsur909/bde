...
// ensures: (__out == 0 ==> matchContextData->d_matchData_p != NULL && matchContextData->d_matchContext_p != NULL) && (__out == k_INTERNAL_ERROR ==> matchContextData->d_matchData_p == NULL && matchContextData->d_matchContext_p == NULL)
int
