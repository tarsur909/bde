...
// PRIVATE ACCESSORS
(__out == 0 ==> (matchContextData->d_matchData_p != 0 ⋆ matchContextData->d_matchContext_p != 0 ⋆ (matchContextData->d_jitStack_p != 0 || d_jitStackSize == 0))) && (__out == k_INTERNAL_ERROR ==> true)
int
...
// ACCESSORS
(__out == RegEx::k_STATUS_SUCCESS ==> (matchContextData != 0)) && (__out != RegEx::k_STATUS_SUCCESS ==> true)
int
