...
// PRIVATE ACCESSORS
// requires: matchContextData != 0 ==> (res_tmp == 0 ==> (matchContextData->d_matchData_p != 0 && matchContextData->d_matchContext_p != 0)) && (res_tmp == k_INTERNAL_ERROR ==> (matchContextData->d_matchData_p == 0 && matchContextData->d_matchContext_p == 0))
// ensures: (__out == 0 ==> (matchContextData->d_matchData_p != 0 && matchContextData->d_matchContext_p != 0)) && (__out == k_INTERNAL_ERROR ==> (matchContextData->d_matchData_p == 0 && matchContextData->d_matchContext_p == 0))
int
