...
// ensures: (__out == 0 ==> (matchContextData->d_matchData_p ↦ _ ⋆ matchContextData->d_matchContext_p ↦ _ ⋆ matchContextData->d_jitStack_p ↦ _)) && (__out == k_INTERNAL_ERROR ==> (matchContextData->d_matchData_p == 0 ⋆ matchContextData->d_matchContext_p == 0 ⋆ matchContextData->d_jitStack_p == 0))
int
...
// ACCESSORS
// requires: matchContextData != nullptr
