...
// requires: true
// ensures: (__out == true ==> ((*path == '.' && !path[1]) || (*path == '.' && path[1] == '.' && !path[2]))) && (__out == false ==> !(*path == '.' && (!path[1] || (path[1] == '.' && !path[2]))))
static inline
...
// requires: path != nullptr && strlen(path) >= 0
// ensures: (__out == true ==> (strlen(path) == 1 && path[0] == '.') || (strlen(path) == 2 && path[0] == '.' && path[1] == '.') || (strlen(path) == 2 && path[0] == '.' && path[1] == '/') || (strlen(path) == 3 && path[0] == '.' && path[1] == '.' && path[2] == '/')) && (__out == false ==> !(strlen(path) == 1 && path[0] == '.') && !(strlen(path) == 2 && path[0] == '.' && path[1] == '.') && !(strlen(path) == 2 && path[0] == '.' && path[1] == '/') && !(strlen(path) == 3 && path[0] == '.' && path[1] == '.' && path[2] == '/'))
static inline
