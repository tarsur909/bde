...
/// ignored.
// requires: path != nullptr && rootEnd >= 0 && rootEnd <= static_cast<int>(bsl::strlen(path))
// ensures: (__out >= path + rootEnd) && (__out < path + length) && (__out == path + rootEnd || isSeparator(*__out))
static
