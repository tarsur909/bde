...
__out != 0 && (__out == "" || __out == "\"/proc\" exists." || __out == "\"/proc\" does not exist.")
static
...
(__out == true ==> (0 == rc && !(s.st_mode & S_IFDIR) && (s.st_mode & executableBits))) && (__out == false ==> (rc != 0 || (s.st_mode & S_IFDIR) || !(s.st_mode & executableBits)))
static inline
