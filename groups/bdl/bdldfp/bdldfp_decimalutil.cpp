...
// requires: str != nullptr && str[0] != 0 && str[1] != 0 && str[2] != 0 && (str[3] == 0 || (str[0] == 's' && str[1] != 0 && str[2] != 0 && str[3] != 0 && str[4] == 0))
// ensures: (__out == true ==> ((str[0] | ' ') == 'n' && (str[1] | ' ') == 'a' && (str[2] | ' ') == 'n' && str[3] == 0)) && (__out == false ==> !((str[0] | ' ') == 'n' && (str[1] | ' ') == 'a' && (str[2] | ' ') == 'n' && str[3] == 0))
