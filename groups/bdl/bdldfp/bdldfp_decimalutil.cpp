...
// requires: true
// ensures: (__out == true ==> ((bsl::strlen(str) == 3 && (str[0] | ' ' == 'n') && (str[1] | ' ' == 'a') && (str[2] | ' ' == 'n')) || (bsl::strlen(str) == 4 && (str[0] | ' ' == 's') && (str[1] | ' ' == 'n') && (str[2] | ' ' == 'a') && (str[3] | ' ' == 'n')))) && (__out == false ==> !(bsl::strlen(str) == 3 && (str[0] | ' ' == 'n') && (str[1] | ' ' == 'a') && (str[2] | ' ' == 'n')) && !(bsl::strlen(str) == 4 && (str[0] | ' ' == 's') && (str[1] | ' ' == 'n') && (str[2] | ' ' == 'a') && (str[3] | ' ' == 'n')))
