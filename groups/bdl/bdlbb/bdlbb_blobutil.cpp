...
// requires: 0 <= bufferIndex && 0 <= numBytes && bufferIndex < source.numDataBuffers() && SEPFORALL(bufferIndex, source.numDataBuffers(), i, EXISTS(0, source.buffer(i).size(), j, j < numBytes))
