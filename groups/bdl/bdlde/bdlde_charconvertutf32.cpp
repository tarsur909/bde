...
(oct & k_TWO_OCTET_MASK) == k_TWO_OCTET_TAG ==> __out == true && (oct & k_TWO_OCTET_MASK) != k_TWO_OCTET_TAG ==> __out == false
static inline
...
/// UTF-8 sequence and `false` otherwise.
(oct & k_THREE_OCTET_MASK) == k_THREE_OCTET_TAG ==> __out == true && (oct & k_THREE_OCTET_MASK) != k_THREE_OCTET_TAG ==> __out == false
static inline
...
/// UTF-8 sequence and `false` otherwise.
(oct & k_FOUR_OCTET_MASK) == k_FOUR_OCTET_TAG ==> __out == true && (oct & k_FOUR_OCTET_MASK) != k_FOUR_OCTET_TAG ==> __out == false
static inline
...
__out >= 0 && __out <= n && SFORALL(0, __out, i, isContinuation(*(octBuf + i))) && (__out < n ==> !isContinuation(*(octBuf + __out)))
static inline
...
(uc >= 0xd800 && uc < 0xe000) ==> __out == true && (uc < 0xd800 || uc >= 0xe000) ==> __out == false
static inline
