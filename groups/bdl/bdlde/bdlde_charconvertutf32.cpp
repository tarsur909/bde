...
__out == 0 || (SEPFORALL(0, __out, i, (octBuf + i ↦ _) && isContinuation(octBuf[i])) ⋆ SEPFORALL(__out, n, i, (octBuf + i ↦ _)) && !isContinuation(octBuf[__out]) || __out == n)
static inline
...
(uc <= 0xFF) ==> __out == true && (uc > 0xFF) ==> __out == false
static inline
