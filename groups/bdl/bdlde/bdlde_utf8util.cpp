...
// requires: (character & k_ONEBYTEHEAD_TEST == k_ONEBYTEHEAD_RES ==> res_tmp == 1) && (character & k_TWOBYTEHEAD_TEST == k_TWOBYTEHEAD_RES ==> res_tmp == 2) && (character & k_THREEBYTEHEAD_TEST == k_THREEBYTEHEAD_RES ==> res_tmp == 3) && ((character & k_ONEBYTEHEAD_TEST != k_ONEBYTEHEAD_RES && character & k_TWOBYTEHEAD_TEST != k_TWOBYTEHEAD_RES && character & k_THREEBYTEHEAD_TEST != k_THREEBYTEHEAD_RES) ==> res_tmp == 4)
...
/// sequence describing a single valid code point.
// requires: pc != nullptr && (pc ↦ _ ⋆ (pc + 1) ↦ _ ⋆ (pc + 2) ↦ _)
...
// requires: invalidString != nullptr && string != nullptr && string[0] != '\0'
// ensures: (__out >= 0 ==> __out == count) && (__out < 0 ==> (*invalidString == string))
...
// requires: invalidString != nullptr && (length == 0 || string != nullptr) && length >= 0
