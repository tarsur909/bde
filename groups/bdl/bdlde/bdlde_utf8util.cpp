...
(__out == (((*pc & 0x1f) << 6) | (pc[1] & k_CONT_VALUE_MASK))) && (pc ↦ _ ⋆ (pc+1) ↦ _)
inline
...
(__out >= 0) || (__out == k_UNEXPECTED_CONTINUATION_OCTET || __out == k_NON_CONTINUATION_OCTET || __out == k_END_OF_INPUT_TRUNCATION || __out == k_OVERLONG_ENCODING || __out == k_SURROGATE || __out == k_INVALID_INITIAL_OCTET || __out == k_VALUE_LARGER_THAN_0X10FFFF) && (__out < 0 ==> (*invalidString != nullptr))
