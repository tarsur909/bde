...
(__out == 1 ==> (character & k_ONEBYTEHEAD_TEST) == k_ONEBYTEHEAD_RES) && (__out == 2 ==> (character & k_TWOBYTEHEAD_TEST) == k_TWOBYTEHEAD_RES) && (__out == 3 ==> (character & k_THREEBYTEHEAD_TEST) == k_THREEBYTEHEAD_RES) && (__out == 4 ==> !((character & k_ONEBYTEHEAD_TEST) == k_ONEBYTEHEAD_RES || (character & k_TWOBYTEHEAD_TEST) == k_TWOBYTEHEAD_RES || (character & k_THREEBYTEHEAD_TEST) == k_THREEBYTEHEAD_RES))
...
/// sequence describing a single valid code point.
(pc ↦ _ ⋆ (pc + 1) ↦ _ ⋆ (pc + 2) ↦ _ ⋆ (pc + 3) ↦ _) && (__out == ((*pc & 0x7) << 18) | ((pc[1] & k_CONT_VALUE_MASK) << 12) | ((pc[2] & k_CONT_VALUE_MASK) << 6) | (pc[3] & k_CONT_VALUE_MASK))
inline
...
(__out >= 0) || (__out < 0 ==> (*invalidString != 0))
