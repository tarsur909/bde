...
// FREE OPERATORS
(__out == true ==> (lhs.d_totalSize == rhs.d_totalSize && lhs.d_bufferSize == rhs.d_bufferSize && SFORALL(0, lhs.d_bufferSize, i, (lhs.d_buffer + i ↦ rhs.d_buffer[i])) && SFORALL(0, 5, i, (bsl::begin(lhs.d_state) + i ↦ bsl::begin(rhs.d_state)[i])))) && (__out == false ==> !(lhs.d_totalSize == rhs.d_totalSize && lhs.d_bufferSize == rhs.d_bufferSize && SFORALL(0, lhs.d_bufferSize, i, (lhs.d_buffer + i ↦ rhs.d_buffer[i])) && SFORALL(0, 5, i, (bsl::begin(lhs.d_state) + i ↦ bsl::begin(rhs.d_state)[i]))))
