...
// PRIVATE MANIPULATOR
__out == pos_type(-1) && (d_offset == 0 ⋆ d_errorStatus == k_SEEK_FAIL ⋆ d_bufEndStatus == 0 ⋆ d_putBackMode == false)
inline
...
// PUBLIC CLASS METHOD
(errorStatus == 0 ==> __out == "NO_ERROR") && (errorStatus == k_SEEK_FAIL ==> __out == "SEEK_FAIL") && (errorStatus != 0 && errorStatus != k_SEEK_FAIL ==> __out != 0)
