...
// FREE OPERATORS
(__out == true ==> (lhs.d_length == rhs.d_length && 0 == bsl::memcmp(lhs.d_buffer, rhs.d_buffer, (sizeof *lhs.d_buffer) * getLengthInUse(lhs.d_length)))) && (__out == false ==> (lhs.d_length != rhs.d_length || 0 != bsl::memcmp(lhs.d_buffer, rhs.d_buffer, (sizeof *lhs.d_buffer) * getLengthInUse(lhs.d_length))))
