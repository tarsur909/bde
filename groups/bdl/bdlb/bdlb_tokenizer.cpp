...
// MANIPULATORS
__out.d_sharedData_p == rhs.d_sharedData_p && __out.d_cursor_p == rhs.d_cursor_p && __out.d_token_p == rhs.d_token_p && __out.d_postDelim_p == rhs.d_postDelim_p && __out.d_end_p == rhs.d_end_p && __out.d_endFlag == rhs.d_endFlag
