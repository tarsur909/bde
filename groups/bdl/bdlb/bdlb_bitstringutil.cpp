...
// requires: (lhs.d_lo >= rhs.d_lo) || (lhs.d_lo + k_BITS_PER_UINT64 >= rhs.d_lo)
// ensures: (__out.d_hi == (lhs.d_hi - rhs.d_hi - (lhs.d_lo < rhs.d_lo ? 1 : 0))) && (__out.d_lo == (lhs.d_lo < rhs.d_lo ? lhs.d_lo + k_BITS_PER_UINT64 : lhs.d_lo) - rhs.d_lo)
inline
...
// ensures: (__out == true) ==> (((word1 >> pos1) ^ (word2 >> pos2)) & BitMaskUtil::lt64(numBits)) != 0
static inline
