...
// ACCESSOR
__out.d_hi ↦ (~old_d_hi + (__out.d_lo < (k_USED_LO_MASK & ~old_d_lo))) ⋆ __out.d_lo ↦ ((k_USED_LO_MASK & ~old_d_lo) + 1 - (__out.d_lo < (k_USED_LO_MASK & ~old_d_lo)) * k_BITS_PER_UINT64)
inline
...
__out.d_hi == lhs.d_hi - rhs.d_hi - (lhs.d_lo < rhs.d_lo) && __out.d_lo == (lhs.d_lo < rhs.d_lo ? lhs.d_lo + k_BITS_PER_UINT64 - rhs.d_lo : lhs.d_lo - rhs.d_lo)
inline
