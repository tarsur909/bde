...
// ACCESSOR
(__out.d_hi ↦ ~old_d_hi + (__out.d_lo & k_UNUSED_LO_MASK != 0)) ⋆ (__out.d_lo ↦ (k_USED_LO_MASK & ~old_d_lo) + 1 - (k_BITS_PER_UINT64 * (__out.d_lo & k_UNUSED_LO_MASK != 0)))
inline
...
(__out.d_hi == lhs.d_hi - rhs.d_hi - (__out.d_lo < (lhs.d_lo - rhs.d_lo))) && (__out.d_lo == (lhs.d_lo - rhs.d_lo) + (__out.d_lo < (lhs.d_lo - rhs.d_lo) ? k_BITS_PER_UINT64 : 0))
inline
...
(__out == ((1ULL << numBits) - 1)) && (0 <= numBits) && (numBits < 64)
static inline
