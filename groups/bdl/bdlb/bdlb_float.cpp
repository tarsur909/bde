...
/// problems.
// requires: true
// ensures: __out == *reinterpret_cast<unsigned long long*>(&number)
inline
...
// requires: true
// ensures: __out == bdlb::Float::k_ZERO || __out == bdlb::Float::k_SUBNORMAL || __out == bdlb::Float::k_NAN || __out == bdlb::Float::k_INFINITE || __out == bdlb::Float::k_NORMAL
inline
