...
// CLASS METHODS
(__out == true ==> (strlen(lhsString) == strlen(rhsString) && SFORALL(0, strlen(lhsString), i, (bdlb::CharType::toLower(lhsString[i]) == bdlb::CharType::toLower(rhsString[i]))))) && (__out == false ==> (strlen(lhsString) != strlen(rhsString) || SEXISTS(0, strlen(lhsString), i, (bdlb::CharType::toLower(lhsString[i]) != bdlb::CharType::toLower(rhsString[i])))))
