...
// ensures: (__out == true ==> (SEPFORALL(0, strlen(lhsString), i, (bdlb::CharType::toLower(lhsString[i]) == bdlb::CharType::toLower(rhsString[i]))) && (strlen(lhsString) == strlen(rhsString)))) && (__out == false ==> (strlen(lhsString) != strlen(rhsString) || SEPEXISTS(0, strlen(lhsString), i, (bdlb::CharType::toLower(lhsString[i]) != bdlb::CharType::toLower(rhsString[i])))))
