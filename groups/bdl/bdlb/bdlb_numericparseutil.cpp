...
namespace bdlb {
                        ...
                        // -----------------------
// CLASS METHODS
// requires: (2 <= base && base <= 36) && (character >= '0' && character <= '9' || character >= 'a' && character <= 'z' || character >= 'A' && character <= 'Z')
// ensures: (Ct::isDigit(character) || Ct::isAlpha(character)) && __out != -1 ==> __out >= 0 && __out < base
