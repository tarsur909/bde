...
// ensures: (__out >= 0 && __out < base) ==> (Ct::isDigit(character) || Ct::isAlpha(character)) && ((Ct::isDigit(character) && __out == character - '0') || (Ct::isAlpha(character) && __out == Ct::toLower(character) - aShift)) || (__out == -1)
