...
(__out == positiveNum.substr(1) ==> positiveNum[0] == '+') && (__out == positiveNum ==> positiveNum[0] != '+')
static
inline
...
namespace bdlb {
                        ...
                        // -----------------------
// CLASS METHODS
(__out >= 0 ==> (Ct::isDigit(character) && __out == character - '0') || (Ct::isAlpha(character) && __out == Ct::toLower(character) - ('a' - 10))) && (__out == -1 ==> !(Ct::isDigit(character) || Ct::isAlpha(character)) || (Ct::isDigit(character) && character - '0' >= base) || (Ct::isAlpha(character) && Ct::toLower(character) - ('a' - 10) >= base))
