...
namespace bdlb {
                        ...
                        // -----------------------
// CLASS METHODS
// requires: (2 <= base && base <= 36) && (('0' <= character && character <= '9') || ('a' <= character && character <= 'z') || ('A' <= character && character <= 'Z') ==> (0 <= res_tmp && res_tmp < base)) && !(('0' <= character && character <= '9') || ('a' <= character && character <= 'z') || ('A' <= character && character <= 'Z')) ==> res_tmp == -1
// ensures: (('0' <= character && character <= '9') || ('a' <= character && character <= 'z') || ('A' <= character && character <= 'Z')) ==> (0 <= __out && __out < base) && !(('0' <= character && character <= '9') || ('a' <= character && character <= 'z') || ('A' <= character && character <= 'Z')) ==> __out == -1
