...
(__out == -1 ==> (!(which & bsl::ios_base::in) || way != bsl::ios_base::beg && way != bsl::ios_base::cur && way != bsl::ios_base::end || __out < 0 || static_cast<bsl::size_t>(__out) > d_bufferSize)) && (__out != -1 ==> __out >= 0 && static_cast<bsl::size_t>(__out) <= d_bufferSize)
