...
// requires: 2 <= (periodDateEnd - periodDateBegin) && *periodDateBegin <= beginDate && beginDate <= *(periodDateEnd - 1) && *periodDateBegin <= endDate && endDate <= *(periodDateEnd - 1) && isSortedAndUnique(periodDateBegin, periodDateEnd)
// ensures: __out == numYears
