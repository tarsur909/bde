...
/// valid `bdlt::Date`.
__out.year() == year && __out.month() == month && __out.day() == ((dayOfFeb == 0 || month != 2) ? day : dayOfFeb) && __out.day() <= bdlt::SerialDateImpUtil::lastDayOfMonth(year, month) && bdlt::Date::isValidYearMonthDay(year, month, __out.day())
inline
